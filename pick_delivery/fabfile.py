...
env.proj_path = "/home/%s/PICK/%s" % (env.user, env.proj_name)
env.manage = "%s/bin/python %s/%s/manage.py" % (env.venv_path, env.proj_path, env.proj_name)
